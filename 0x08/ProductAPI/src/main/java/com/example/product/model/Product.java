...
public class Product {
    ...
    public boolean equals(Object o) {
        ...
        return id.equals(product.id) && code.equals(product.code) && name.equals(product.name) && description.equals(product.description) && price.equals(product.price) && createdOne.equals(product.createdOne) && status.equals(product.status);
    }
